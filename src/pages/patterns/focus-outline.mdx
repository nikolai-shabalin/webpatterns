...
<Layout>
  ...
  *:focus-visible {
  ...
  Этот способ также подойдёт для сайтов с светлой темой и тёмными блоками, и наоборот. Это сработает потому что текст будет контрастным к цвету фона, а значит и цвет обводки будет контрастным к цвету фона.
